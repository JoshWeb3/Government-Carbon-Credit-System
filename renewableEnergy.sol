...
contract renewableEnergy is Ownable, ERC20, ERC20Burnable {
    ...
    //helper contracts for the frontend
    function GetIsInspector() public view returns (bool) {
        return isInspector[msg.sender] == true;
    }

  /*  function GetIsGovernment() public view returns (bool) {
        return 
    }*/
    ...
    contract taxes {
        ...
        function redeemCredits () public {
            ...
            _renewableEnergy.burn(addresstoPerson[msg.sender].balance);
